...
drop table if exists CaixaStaffGeral;
...
drop table if exists CaixaPagamento;
...
create table Atuacao (
    ...
    CONSTRAINT FormatoDuracao CHECK (duracao LIKE "__:__"),
    PRIMARY KEY (id)
);
...
create table Funcionario (
    ...
    nome TEXT NOT NULL,
    nrTelemovel INTEGER NOT NULL CONSTRAINT NrTelemovelInvalido CHECK((nrTelemovel >= 910000000 AND nrTelemovel <= 939999999) OR (nrTelemovel >= 960000000 AND nrTelemovel <= 969999999)),
    BI INTEGER NOT NULL UNIQUE CONSTRAINT BIInvalido CHECK ( BI <= 99999999), 
    morada TEXT,   
...
create table CaixaStaffGeral (
    idStaff INTEGER NOT NULL REFERENCES StaffGeral
                            ON DELETE CASCADE ON UPDATE CASCADE,
    idCaixa INTEGER NOT NULL REFERENCES CaixaPagamento
                            ON DELETE CASCADE ON UPDATE CASCADE,
