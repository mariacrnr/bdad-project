...
BEGIN
    WHERE NEW.idLounge.idDiscoteca <> (Membro.idDiscoteca com NEW.idReserva.BI)
    -- Se a pessoa referenciada por Reserva.BI NÃO for membro VIP na discoteca do Lounge, remover inserção
END;